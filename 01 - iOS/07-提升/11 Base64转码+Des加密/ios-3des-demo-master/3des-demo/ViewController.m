...
- (void)viewDidLoad {
    ...
    NSString * base64Key = @"ckwLSyYMxxHWCgsWkdmySh6JldPHQvSF";
    NSString * base64Iv = @"sjuX1wxiKBE=";

    NSString * encoded = [self doSKCipher:@"123456abcdef" enc:kCCEncrypt key:base64Key iv:base64Iv];
